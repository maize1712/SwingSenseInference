...
// the private section.
// On some Arduino toolchains the injected private operator delete causes
// compiler access errors when placement-new is used. To avoid those
// build-time issues (and because we don't use operator delete), keep this
// macro empty for embedded builds.
